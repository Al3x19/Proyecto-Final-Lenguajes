...
export const SoftwareList = () => {
  return (
    ...
    //   <div className="w-96 h-80 bg-zinc-50">Card 1</div>
    //   <div className="w-96 h-80 bg-zinc-50">Card 2</div>
    //   <div className="w-96 h-80 bg-zinc-50">Card 3</div>
    //   <div className="w-96 h-80 bg-zinc-50">Card 4</div>
    //   <div className="w-96 h-80 bg-zinc-50">Card 5</div>
    //   <div className="w-96 h-80 bg-zinc-50">Card 6</div>
    // </div>
<div className="min-h-screen bg-gradient-to-tr from-slate-400 to-yellow-200 flex justify-center items-center py-20">
